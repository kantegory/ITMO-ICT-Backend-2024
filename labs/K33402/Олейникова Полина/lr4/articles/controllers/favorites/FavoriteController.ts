...
export default class FavoriteController {
    ...
    get = async (request: any, response: any) => {
        try {
            ...
            const favorites = await this.favoriteService.getAll(userId)
    ...
    create = async (request: any, response: any) => {
        try {
            const userId = request.headers['user-id']
            await this.favoriteService.create(userId, request.params.articleId)
    ...
    delete = async (request: any, response: any) => {
        try {
            const userId = request.headers['user-id']
            await this.favoriteService.delete(userId, request.params.articleId)
