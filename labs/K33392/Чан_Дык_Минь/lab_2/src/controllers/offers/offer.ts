...
export default class OfferController {
    ...
    getOfferForUser = async (request: any, response: any) => {
        try {
            ...
            const { type, max_price } = request.body; // Lấy giá trị của type và price từ yêu cầu
    
            // Gọi phương thức getOfferForUser với các giá trị type và price nếu được chỉ định
