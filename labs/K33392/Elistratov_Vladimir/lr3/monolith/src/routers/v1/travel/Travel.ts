...
router.route("/list/by/dep_and_dest_city/:dep_city_id/:dest_city_id")
    .get(controller.listFindAllByDestinationAndDepartureCityId)
router.route("/one/:id").get(controller.getFindById)
router.route("/list/by/seats_number/:seats_number").get(controller.listFindByNumberOfSeats)
