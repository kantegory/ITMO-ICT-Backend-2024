...
const Place_1 = require("../../models/place/Place");
class PlaceService {
    constructor() {
        this.placeRepository = database_1.default.getRepository(Place_1.Place);
    }
    create(data) {
        try {
    ...
    updateById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.placeRepository.update(data, {
                where: {
                    id: id
                },
                returning: true
