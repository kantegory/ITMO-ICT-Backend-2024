...
const UserInfo_1 = require("../../models/userInfo/UserInfo");
class UserInfoService {
    constructor() {
        this.userInfoRepository = database_1.default.getRepository(UserInfo_1.UserInfo);
    }
    create(data) {
        try {
    ...
    updateById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.userInfoRepository.update(data, {
                where: {
                    id: id
                },
                returning: true
