...
***Можно сделать в паре при двух условиях: наличие рекомендательной системы для предложения товаров, которые стоит посетить или увеличение объёма работы в несколько раз (это надо согласовать).***
