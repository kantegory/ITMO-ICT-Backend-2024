...
class ExchangeRequestController {
    ...
    getAll = async (request: any, response: any) => {
        try {
            const url = `http://localhost:${process.env.BOOK_SERVICE_PORT}/bookService/exchangeRequests/`
    ...
    getById = async (request: any, response: any) => {
        ...
        try {
            const url = `http://localhost:${process.env.BOOK_SERVICE_PORT}/bookService/exchangeRequests/${id}`
